...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen bg-[#d6d3d1] overflow-hidden flex flex-col relative selection:bg-[#EAB308] selection:text-black">
      ...
      <div className="absolute top-6 left-6 md:top-8 md:left-8 z-50 mix-blend-difference text-[#1c1917]">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-sm">
           ...
           <span className="text-[10px] font-mono uppercase tracking-widest text-stone-800 font-bold">Widget Study</span>
        </div>
      </div>
      ...
      <div 
        ref={scrollRef}
        className="flex-1 w-full overflow-x-auto overflow-y-hidden flex items-center px-8 md:px-[10vw] gap-6 md:gap-[15vw] hide-scrollbar relative z-10 cursor-ew-resize snap-x snap-proximity flex-nowrap"
      >
        
        {/* Intro Section - Snap Point */}
        <div className="min-w-[85vw] md:min-w-[400px] snap-center flex flex-col justify-center space-y-6 flex-shrink-0">
        ...
        {/* Widgets - Snap Points */}
        <div className="snap-center pt-4 md:pt-10 flex-shrink-0">
           <AudioWidget />
        </div>
        ...
        {/* Outro / Footer */}
        <div className="min-w-[85vw] md:min-w-[400px] snap-center flex flex-col justify-center items-start opacity-60 flex-shrink-0">
